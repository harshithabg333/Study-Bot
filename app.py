...
prompt = ChatPromptTemplate.from_messages(
    [
        ("system", "You are an AI Study Assistant. Help students understand concepts clearly with examples"),
        ("placeholder","{history}"),
        ("user", "{question}")
...
#Random user Id wil be generated
...
@app.get("/")
def home():
    return {"Welcome to AI Study Assistant - Study Bot API"}
@app.post("/chat")
def chat(request:ChatRequest):
    ...
    #User data is stored in MongoDb in below format
